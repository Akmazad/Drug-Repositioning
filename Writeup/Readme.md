...
- <em>In silico</em> approaches may offer the repositioning of a low side-effect candidate drug in the place of a drug with high side-effect, even though the direct associations between the candidate drugs and the diseases of the query drug are absent in the literature or gold-standard data.
...
# DrugRepo: Our approach
 ...
 - Method: 
    ...
    + A [```shiny app```](https://unsw-data-analytics.shinyapps.io/drugrepo) for this project is under construction 
